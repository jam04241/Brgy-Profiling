...
################################################################################
## Form generated from reading UI file 'finalOfficialDialog.ui'
##
...
"}")
        ...
        self.layoutWidget.setGeometry(QRect(80, 91, 391, 416))
        ...
        self.firstname_lineEdit2 = QLineEdit(self.layoutWidget)
        ...
        self.lastname_lineEdit2 = QLineEdit(self.layoutWidget)
        ...
        self.age_lineEdit2 = QLineEdit(self.layoutWidget)
        ...
        self.gender_comboBox2 = QComboBox(self.layoutWidget)
        ...
        self.position_comboBox = QComboBox(self.layoutWidget)
        ...
        self.birthplace_lineEdit2 = QLineEdit(self.layoutWidget)
        ...
        self.termstart_dateEdit = QDateEdit(self.layoutWidget)
        ...
        self.termend_dateEdit = QDateEdit(self.layoutWidget)
        ...
        self.emailaddress_lineEdit2 = QLineEdit(self.layoutWidget)
    ...
    def retranslateUi(self, OfficialDialog):
        OfficialDialog.setWindowTitle(QCoreApplication.translate("OfficialDialog", u"Add Official", None))
        ...
        self.label_16.setText(QCoreApplication.translate("OfficialDialog", u"Gender", None))
        self.gender_comboBox2.setItemText(0, "")
