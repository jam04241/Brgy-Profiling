...
################################################################################
## Form generated from reading UI file 'ResidentDialog2.ui'
##
...
"}")
        ...
        self.layoutWidget.setGeometry(QRect(30, 90, 491, 431))
        ...
        self.firstname_lineEdit = QLineEdit(self.layoutWidget)
        ...
        self.lastname_lineEdit = QLineEdit(self.layoutWidget)
        ...
        self.PWD_comboBox = QComboBox(self.layoutWidget)
        ...
        self.birthplace_lineEdit = QLineEdit(self.layoutWidget)
        ...
        self.emailaddress_lineEdit = QLineEdit(self.layoutWidget)
        ...
        self.layoutWidget1.setGeometry(QRect(330, 541, 191, 31))
        self.horizontalLayout_3 = QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.cancel_residentbutton = QPushButton(self.layoutWidget1)
...
"}")
        ...
        self.save_residentbutton = QPushButton(self.layoutWidget1)
